...
class OrderDataTest {
    ...
    void testUpdateOrderTemplate() throws URISyntaxException, JsonProcessingException {
		...
		final String url="http://localhost:8080/updateorder";
		URI uri=new URI(url);
    ...
    void addCartToOrder()
    {
        ...
        RestTemplate template=new RestTemplate();
        assertEquals(HttpStatus.OK,template.exchange("http://localhost:8080/placeorder/"+cid, HttpMethod.POST,entity,String.class).getStatusCode());
    }
	/*@Test
    ...
    void testGetById()
    {
        ...
        RestTemplate template=new RestTemplate();
        assertEquals(HttpStatus.OK,template.exchange("http://localhost:8080/getorderbyid/"+id, HttpMethod.GET,entity,String.class).getStatusCode());
    }
	@Test
