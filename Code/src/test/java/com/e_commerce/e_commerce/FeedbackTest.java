...
class FeedbackTest {
    ...
    void testGetFeedback() throws URISyntaxException, JsonProcessingException {
      ...
      final String url="http://localhost:8080/savefeed";
      URI uri=new URI(url);
    ...
    void testAdminFeedback()  throws URISyntaxException, JsonProcessingException {
        ...
        final String url="http://localhost:8080/admin/giveFeedback/"+id;
        URI uri=new URI(url);
        HttpHeaders headers = new HttpHeaders();
    ...
    void testGetAllFeedback() throws URISyntaxException, JsonProcessingException {
      RestTemplate template=new RestTemplate();
      final String url="http://localhost:8080/getallfeedback";
      URI uri=new URI(url);
